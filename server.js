...
middlewares.asFile(app, ['favicon.png', 'favicon.ico', 'logo.png', 'logo_black.png', 'icon.png', 'style.css', 'js/utils.js', 'js/api.js', 'js/side-bar.js', 'js/theme.js']);
middlewares.asPageFile(app, [{ file: 'login', path: '/' }, 'login', 'setup', 'status', 'rpc', 'validator', 'settings', 'eth-stats', 'wallet', 'hyperions', 'ibc-relayers', 'backups', 'versions']);
